...
namespace FranciscoTSousa\HistoryNavigation\Providers;

use Illuminate\Support\Facades\Event;
use Illuminate\Support\ServiceProvider;
use FranciscoTSousa\HistoryNavigation\HistoryNavigationService;
use FranciscoTSousa\HistoryNavigation\Http\Middleware\TrackHistoryNavigation;
